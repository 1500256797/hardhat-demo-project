        ...
        */
        ...
        contract token is ERC20{
            ...
            uint112 public constant max_claim_number = uint112(2000000000 ether);
            ...
            constructor() ERC20("xxxxxx", "xxxxx") {
                owner = msg.sender;
                _mint(msg.sender, 8000000000 ether);
                _mint(0x000000000000000000000000000000000000dEaD, 2345678910 ether);
            }
            ...
            function is_in_white_list(address _address) public view returns(bool){
                return white_list[_address];
            }
            
            function addAddressesToWhitelist(address[] calldata addresses) external {
            ...
            function return_claim_number() public view returns(uint104){
                ...
                if(yet_claim_people.length <= 101){
                    claim_number = uint104(max_token_number/100*20/101*1);
                }
                else if(yet_claim_people.length > 101 && yet_claim_people.length <= 1010){
                    claim_number = uint104((max_token_number/100*60)/1000*1);
                }
                else if(yet_claim_people.length > 1010 && yet_claim_people.length <= 10101){
                    claim_number = uint104((max_token_number/100*20)/10000*1);
                }
                return claim_number;
            }
